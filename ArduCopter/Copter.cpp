...
const AP_Scheduler::Task Copter::scheduler_tasks[] = {
    ...
    SCHED_TASK_CLASS(GCS,                  (GCS*)&copter._gcs,          update_receive, 400, 180, 102),  //更新接收mavlink消息
    SCHED_TASK_CLASS(GCS,                  (GCS*)&copter._gcs,          update_send,    400, 550, 105), //更新发送mavlink消息
